...
- **多投影平面地图视图**，支持等距柱状、墨卡托、自然地球、Equal Earth 等面积、正射半球、方位等面积、球极平射与心射投影，可拖拽旋转投影中心/倾角、滚轮缩放并一键重置默认视角
...
- **中心经度 / 中心纬度 / 地图倾角 γ / 地图缩放** 控件（仅平面地图模式）：改变投影观察中心、倾角和预览缩放。也可在平面地图上用鼠标左键拖拽旋转投影；拖到当前投影范围外时会像 D3 示例一样转为调整 γ。**重置地图视角** 会恢复默认等距柱状、中心经纬度 0°/0°、γ 0° 和 1.00× 缩放。导出不受影响，仍输出标准等距柱状 PNG。
